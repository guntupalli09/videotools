...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Yes. VideoText free tier: 3 uploads/month with no credit card. Exported SRT files are watermark-free on paid plans. On the free tier, a VideoText watermark appears in exports — upgrade to Pro ($7.99/month) to remove it.',
  },
]
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-500">
      ...
      <div className="max-w-4xl mx-auto px-6 pb-24 space-y-16">
        ...
        <section className="rounded-xl border border-white/[0.08] bg-gray-950 p-8 text-center sm:p-12">
          ...
          <p className="text-white/55 mb-8 max-w-xl mx-auto">Upload any video and get a proper SRT subtitle file in minutes. Upload it to YouTube, translate it, or burn it into your video — all from one tool.</p>
          <Link to="/video-to-subtitles">
