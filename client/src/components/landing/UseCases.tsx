...
const USE_CASES = [
  {
    ...
    iconBg: 'bg-red-500',
    label: 'For YouTubers',
    headline: 'Paste a link. Get a transcript.',
    description: 'No downloads, no plugins. Drop your YouTube URL directly — our system streams the audio and transcribes it without you touching a file.',
    points: [
      'Works with any public YouTube video',
      'Chapter markers auto-detected',
      'Perfect for repurposing long-form content',
    ],
    cta: 'Try YouTube transcription',
