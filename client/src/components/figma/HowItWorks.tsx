...
import { Upload, Cpu, Download, Shield } from 'lucide-react';
...
const steps = [
  ...
  },
  {
    ...
    icon: Download,
    title: 'Download & use',
    description: 'Get your transcript, SRT, or subtitle file in under 60 seconds. Export as TXT, JSON, DOCX, PDF, or VTT.',
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4 transition-colors duration-500">
            Three steps.
            <span className="block text-gray-400 dark:text-white/30 transition-colors duration-500">Under a minute.</span>
          </h2>
        </motion.div>
        ...
        <motion.div
          ...
          className="mt-16 p-6 sm:p-8 rounded-2xl bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-white/[0.07] transition-colors duration-500"
        >
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="w-10 h-10 rounded-xl bg-purple-100 dark:bg-purple-500/15 flex items-center justify-center flex-shrink-0 transition-colors duration-500">
              <Download className="w-5 h-5 text-purple-600 dark:text-purple-400" />
            </div>
            <div className="flex-1">
              <h3 className="text-base font-bold text-gray-900 dark:text-white mb-1 transition-colors duration-500">
            ...
            <Link
              to="/guide"
              className="text-sm font-semibold text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 whitespace-nowrap transition-colors flex-shrink-0"
            >
              Full guide →
            </Link>
          </div>
