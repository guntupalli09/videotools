...
export const TEX_ENTRIES: TexEntry[] = [
  ...
  },
  {
    ...
    answer:
      "Sign up to try free (3 uploads/month, no credit card). When you're ready for continued processing or more features (batch, multi-language, no watermark), subscribe from Pricing.",
